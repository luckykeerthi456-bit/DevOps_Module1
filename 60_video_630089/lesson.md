# Storage in the Cloud - Spanner | Google Skills for Partners
...
- **Original URL:** https://partner.skills.google/paths/20/course_sessions/39706059/video/630089
- **Lesson type:** `video`
- **Path ID:** `20`
- **Container type:** `course_sessions`
- **Container ID:** `39706059`
- **Lesson ID:** `630089`
- **Generated:** 2026-07-10 04:59:39
...
### YouTube Video `tF74FJe9RJI`

[![Play Video](assets/youtube_thumbnail_001.jpg)](https://www.youtube.com/watch?v=tF74FJe9RJI)
...
The third core storage option offered by Google Cloud is Spanner.
...
The third core storage option offered by Google Cloud is Spanner. 00:04 Spanner is a fully managed relational database service that scales horizontally, is strongly consistent, and speaks SQL. 00:12 Battle tested by Google’s own mission- critical applications and services, Spanner is the service that powers Google’s $80 billion business. 00:20 Spanner is especially suited for applications that require a SQL relational database management system with joins and 00:26 secondary indexes, built-in high availability, strong global consistency, and high numbers of input and output operations per second. 00:37 We’re talking tens of thousands of reads and writes per second or more.
...
- [Resource](https://partner.skills.google/paths/20/course_sessions/39706059/video/630090)
