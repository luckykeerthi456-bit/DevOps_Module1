# Storage in the Cloud - Google Cloud storage options | Google Skills for Partners
...
- **Original URL:** https://partner.skills.google/paths/20/course_sessions/39706059/video/630085
- **Lesson type:** `video`
- **Path ID:** `20`
- **Container type:** `course_sessions`
- **Container ID:** `39706059`
- **Lesson ID:** `630085`
- **Generated:** 2026-07-10 04:58:16
...
### YouTube Video `8Dn-RAP7fzA`

[![Play Video](assets/youtube_thumbnail_001.jpg)](https://www.youtube.com/watch?v=8Dn-RAP7fzA)
...
In this section of the course, we’ll explore Google Cloud’s five core storage products: Cloud Storage, Cloud SQL, Spanner, Firestore, and Bigtable.
...
Every application needs to store data, like media to be streamed or perhaps even sensor data from devices, and different applications and workloads require different storage database solutions. 00:12 Google Cloud has storage options for structured, unstructured, transactional, and relational data. 00:20 In this section of the course, we’ll explore Google Cloud’s five core storage products: Cloud Storage, Cloud SQL, Spanner, Firestore, and Bigtable. 00:34 Depending on your application, you might use one or several of these services to do the job.
